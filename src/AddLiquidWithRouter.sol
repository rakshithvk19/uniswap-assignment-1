...
contract AddLiquidWithRouter {
     ...
     *
     *  This contract is a pool that has an initial balance of 1000 USDC and 1 ETH.
     *  Mint a position (deposit liquidity) in this pool of USDC/ETH to `msg.sender`.
     *  The challenge is to use Uniswapv2 router to add liquidity to the pool.
     *  The interface is provided below the contract code.
     *
     */
